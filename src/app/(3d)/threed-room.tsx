...
}>, length: number, width: number, scene: THREE.Scene, objs: number[]) {
...
function initStuff(stuffModel: THREE.Group<THREE.Object3DEventMap>, shelfCategort: ShelfCategory, stuffCagegroy: Category) {
  ...
  stuffModel.scale.set(scale / 10 * shelfCategort.scale, scale / 10 * shelfCategort.scale, scale / 10 * shelfCategort.scale);
